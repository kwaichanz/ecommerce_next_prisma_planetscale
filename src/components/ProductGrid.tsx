...
const ProductGrid = (props: IProductGrid) => {
  ...
  // Introducing useInview hook to find the user's cursor on the screen to then load 12 rows from the last cursor
  useEffect(() => {
    if (inView) {
  ...
  // Showing grid of product cards with title, price and view more button
